      ...
      >
        {bannerList.map((banner) => (
          ...
          >
            ...
            {/* Overlay on Hover */}
            <div className="absolute inset-0 bg-black/30 opacity-0 rounded-lg group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center text-center p-4">
